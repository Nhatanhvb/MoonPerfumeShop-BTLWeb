    ...
    <div class="container">
      <div class="header-main__wrapper">
        ...
        <ul class="header-nav">
          ...
          <li class="header-nav__item">
            <a href="?action=sale" class="header-link active">khuyến mãi</a>
          </li>
          <li class="header-nav__item">
          ...
          <?php foreach ($products as $product): ?>
              <div class="col-md-3 col-sm-4">
                <div class="single-new-arrival">
                  ...
                  <?php
                  $discount = $product['MaKhuyenMai'] * 10;
                  $discountedPrice = $product['GiaTien'] * (1 - $discount / 100);
                  ?>
                            <p class="arrival-product-price"><?php echo number_format($discountedPrice, 0, ',', '.') ?> ₫</p>
                </div>
              </div>
          <?php endforeach; ?>
        </div>
